...
def detect_intent_texts(project_id, session_id, language_code):
    ...
    # with open('NLU_V2/test-nlu-v3_with_labels', 'rb') as fp:
    with open('NLU_V2/test-nlu-v3_with_intent', 'rb') as fp:
    ...
    with open('log.txt', 'w') as log:
        for index, example in enumerate(TEST_DATA):
            ...
            print(intent_predicted, label)

            if intent_predicted.strip():
                predictions.append(intent_predicted)
            else:
            ...
            for ent in parameters:
                ...
                item = parameters[ent].string_value
                try:
