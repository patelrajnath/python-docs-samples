...
with open ("HuaweiAccount/train-accounts_with-labels", 'rb') as fp:
...
basedir = 'accounts-data_with_entities'
...
for key in intent_query_dict:
    ...
    with open(basedir + '/intents/accounts.agent.' + key_slug + '.json', 'w') as outfile:
        json.dump(payload_template_response, outfile)

    with open(basedir + '/intents/accounts.agent.' + key_slug + '_usersays_en.json', 'w') as outfile:
