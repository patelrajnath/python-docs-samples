...
train_df = pd.read_csv('AskUbuntu/ask_ubuntu_train60_splits.csv')
valid_df = pd.read_csv('AskUbuntu/ask_ubuntu_val10_splitss.csv')
...
for key in intent_query_dict:
    ...
    with open('ubuntudata/intents/ubuntu.agent.' + key_slug + '.json', 'w') as outfile:
    ...
    with open('ubuntudata/intents/ubuntu.agent.' + key_slug + '_usersays_en.json', 'w') as outfile:
